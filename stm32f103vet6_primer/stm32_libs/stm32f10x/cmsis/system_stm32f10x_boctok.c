...
/* Define one of the following SYSCLK options, or you will stuck to 8 MHz */

// HSI clocks the PLL, and the PLL is used as system clock source (64 MHz)
//#define SYSCLOCK_HSI64

// 8 MHz HSE clocks the PLL, and the PLL is used as system clock source (64 MHz)
//#define SYSCLOCK_HSE64

// 8 MHz clocks the PLL, and the PLL is used as system clock source (72 MHz)
//#define SYSCLOCK_HSE72

// HSI gives 8 MHz System Clock *boring*
//#define SYSCLOCK_HSI8
...
static void SetSysClock_HSE72(void);
static void SetSysClock_HSE64(void);
...
static void SetSysClock_HSE64(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*  PLL configuration: PLLCLK = 8 * 8 = 64 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
...
static void SetSysClock(void)
{
#ifdef SYSCLOCK_HSI64
  SetSysClock_HSI64();
#elif defined SYSCLOCK_HSE64
  SetSysClock_HSE64();
#elif defined SYSCLOCK_HSE72
  SetSysClock_HSE72();  
#else
  SetSysClock_HSI();  
#endif
